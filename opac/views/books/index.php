            ...
            <div class="list-group" id="bookList">
                ...
                <div class="list-group-item list-group-item-action book-item" 
                    ...
                    <div class="d-flex w-100 justify-content-between">
                        ...
                        <small class="number-label">Call Number: <?php echo $item['call_number']; ?></small>
                    </div>
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <a href="show.php?id=<?php echo $item['id']; ?>" class="btn btn-sm btn-outline-primary">View Details</a>
                    </div>
                </div>
                <?php endforeach; ?>
            </div>
